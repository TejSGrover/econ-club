...
export const StaggeredMenu = ({
                                  ...
                                  // ✅ Give it default items so you don't see "No items"
                                  items = [
                                      { label: "Home", link: "#", ariaLabel: "Go to Home" },
                                      { label: "Meetings", link: "#meetings", ariaLabel: "Go to Meetings" },
                                      { label: "Topics", link: "#topics", ariaLabel: "Go to Topics" },
                                      { label: "Join", link: "https://example.com", ariaLabel: "Join Econ Club" }
                                  ],
                                  socialItems = [],
                                  displaySocials = true,
                                  displayItemNumbering = true,
                                  className,
                                  // ✅ Use an optional logo; you can set logoUrl={null} to hide
                                  logoUrl = null,
                                  menuButtonColor = "#fff",
                                  openMenuButtonColor = "#fff",
                                  accentColor = "#5227FF",
                                  changeMenuColorOnOpen = true,
                                  isFixed = true, // ✅ make it fixed by default
